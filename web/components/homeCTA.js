...
export default function HomeCTA() {
  return (
    <div className="home-container">
      <h1 className="section-header">What is HappyR?</h1>
      <p className="section-subheader">It lets you find happy hour deals in one click to...</p>
      <div className="cta-container">
        <div className="cta-section">
          <h1>Connect with Colleagues</h1>
          <p>HappyR helps you find places to unwind with great deals to share with others to bond.</p>
        </div>
        <div className="cta-section">
        ...
        <div className="cta-section">
          ...
          <p>Take advantage of HappyR to spend quality bonding time with friends at a great price.</p>
        </div>
      </div>
    </div>
  )
